 ...
 */
public class VentanaListarMatriculasNCursos extends JFrame {
	/**
	 * 
	 */
	 ...
	 * @generated "UML a Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	private static VentanaListarMatriculasNCursos uniqueInstance;
	...
	public static VentanaListarMatriculasNCursos getInstance() {
		// begin-user-code
		
		if(uniqueInstance == null) {
			uniqueInstance = new VentanaListarMatriculasNCursos();
		}
	...
	public VentanaListarMatriculasNCursos(){
		super("Listar Matriculas con N Cursos");
	...
	public class ALVentanaListarMatriculas implements ActionListener{
		...
		public void actionPerformed(ActionEvent event) {
			...
			if(event.getSource() == botonAtras){
				VentanaListarMatriculasNCursos.this.dispose();
	...
	public void update(int evento, Object datos) {
		...
		switch (evento) {
		case (EventoGUI.LISTAR_MATRICULA_NCURSOS):{
		...
		case (EventoGUI.LISTAR_MATRICULA_NCURSOS_ERROR):{
			...
			JOptionPane.showMessageDialog(null, "No hay matriculas con estás características");
